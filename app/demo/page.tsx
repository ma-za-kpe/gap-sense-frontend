...
export default function Home() {
  ...
  const slides = [
    // Slide 1: Cover
    <div key={0} className="flex flex-col items-center justify-center text-center h-full">
      <h1 className="text-[56px] font-bold text-whatsapp-500 mb-4">GapSense</h1>
      <p className="text-2xl text-gold-500 font-semibold mb-8">AI-Powered Learning Gap Diagnostics for Ghana</p>
      <p className="text-lg text-slate-600 max-w-[500px]">Empowering teachers to identify and close foundational math gaps through WhatsApp</p>
      <div className="mt-12 p-4 bg-whatsapp-50 rounded-xl max-w-[400px]">
        <p className="text-base font-semibold text-whatsapp-600 mb-1">UNICEF StartUp Lab Cohort 6</p>
        <p className="text-sm text-slate-500">Application • March 2026</p>
      </div>
    </div>,

    // Slide 2: The Crisis
    <div key={1} className="flex flex-col items-center justify-center text-center h-full">
      <h2 className="text-4xl font-bold text-slate-800 mb-6">Ghana's Hidden Learning Crisis</h2>
      <div className="text-[96px] font-bold text-gold-500 mb-2">84%</div>
      <p className="text-lg text-slate-700 mb-2">Of children aged 7-14 lack foundational numeracy</p>
      <p className="text-sm text-slate-400 italic mb-8">UNICEF MICS 2023</p>

      <div className="flex gap-8 mb-8">
        <div>
          <p className="text-2xl font-bold text-whatsapp-500 bg-whatsapp-50 px-4 py-2 rounded-lg">&lt;25%</p>
          <p className="text-sm text-slate-600 mt-2">Primary 4 at math level</p>
        </div>
        <div>
          <p className="text-2xl font-bold text-whatsapp-500 bg-whatsapp-50 px-4 py-2 rounded-lg">55%</p>
          <p className="text-sm text-slate-600 mt-2">Have misconceptions</p>
        </div>
      </div>

      <div className="bg-gold-50 p-6 rounded-xl border-l-4 border-gold-500 max-w-[550px]">
        <p className="text-xl italic text-slate-700">"Teachers know students are struggling, but can't pinpoint which foundational skills are missing."</p>
      </div>
    </div>,

    // Slide 3: Root Problem
    <div key={2} className="flex flex-col items-center justify-center h-full px-8">
      <h2 className="text-4xl font-bold text-slate-800 mb-8 text-center">Why Current Solutions Fail</h2>
      <div className="grid grid-cols-3 gap-6 max-w-4xl">
        <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-red-500">
          <h3 className="text-lg font-semibold text-slate-800 mb-3">❌ No Diagnostic Tools</h3>
          <p className="text-sm text-slate-600 mb-2">• No way to assess foundational gaps</p>
          <p className="text-sm text-slate-600">• Paper tests take weeks to analyze</p>
        </div>
        <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-red-500">
          <h3 className="text-lg font-semibold text-slate-800 mb-3">❌ No Teacher Support</h3>
          <p className="text-sm text-slate-600 mb-2">• 120K+ teachers lack training</p>
          <p className="text-sm text-slate-600">• Class sizes of 40+ students</p>
        </div>
        <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-red-500">
          <h3 className="text-lg font-semibold text-slate-800 mb-3">❌ No Parent Involvement</h3>
          <p className="text-sm text-slate-600 mb-2">• Parents don't know child's gaps</p>
          <p className="text-sm text-slate-600">• Language barriers to resources</p>
        </div>
      </div>
    </div>,

    // Slide 4: Solution
    <div key={3} className="flex flex-col items-center justify-center text-center h-full">
      <h2 className="text-4xl font-bold text-slate-800 mb-4">The GapSense Solution</h2>
      <p className="text-lg text-slate-600 mb-8">AI-Powered Gap Diagnostics via WhatsApp</p>
      <div className="flex items-center justify-around max-w-3xl mb-6">
        <div className="text-center">
          <p className="text-5xl mb-2">📸</p>
          <p className="text-sm font-semibold text-slate-700">Teacher Uploads</p>
          <p className="text-xs text-slate-500">Exercise book photo</p>
          <p className="text-xs text-gold-500 font-semibold">30 seconds</p>
        </div>
        <p className="text-4xl text-whatsapp-500">→</p>
        <div className="text-center">
          <p className="text-5xl mb-2">🤖</p>
          <p className="text-sm font-semibold text-slate-700">AI Analyzes</p>
          <p className="text-xs text-slate-500">Ghana curriculum</p>
          <p className="text-xs text-gold-500 font-semibold">8 seconds</p>
        </div>
        <p className="text-4xl text-whatsapp-500">→</p>
        <div className="text-center">
          <p className="text-5xl mb-2">📊</p>
          <p className="text-sm font-semibold text-slate-700">Report Generated</p>
          <p className="text-xs text-slate-500">Gap profile</p>
          <p className="text-xs text-gold-500 font-semibold">Instant</p>
        </div>
      </div>
      <p className="text-sm text-slate-600">✅ No app download  |  ✅ Works offline  |  ✅ Local languages  |  ✅ Free for public schools</p>
    </div>,
    ...
    <div key={7} className="flex flex-col items-center justify-center h-full px-8">
      <h2 className="text-4xl font-bold text-slate-800 mb-8 text-center">Sustainable Impact at Scale</h2>
      <div className="grid grid-cols-3 gap-6 max-w-4xl mb-6">
        <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-whatsapp-500 text-center">
          <h3 className="text-lg font-semibold text-slate-800 mb-2">🏫 Public Schools</h3>
          <div className="text-2xl font-bold text-whatsapp-500 my-3">FREE</div>
          <p className="text-sm text-slate-600 mb-2">• Government/UNICEF partnerships</p>
          <p className="text-sm text-slate-600">• 100% coverage goal</p>
        </div>
        <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-gold-500 text-center">
          <h3 className="text-lg font-semibold text-slate-800 mb-2">🎓 Private Schools</h3>
          <div className="text-2xl font-bold text-gold-500 my-3">$2/year</div>
          <p className="text-sm text-slate-600 mb-2">• Full analytics dashboard</p>
          <p className="text-sm text-slate-600">• $1.6M revenue potential</p>
        </div>
        <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-gold-500 text-center">
          <h3 className="text-lg font-semibold text-slate-800 mb-2">🤝 B2B Licensing</h3>
          <div className="text-2xl font-bold text-gold-500 my-3">$50-200K</div>
          <p className="text-sm text-slate-600 mb-2">• EdTech platforms</p>
          <p className="text-sm text-slate-600">• NGO programs</p>
        </div>
      </div>
      <div className="bg-gold-50 p-5 rounded-xl max-w-[600px] border-l-4 border-gold-500">
        <h3 className="text-lg font-semibold text-slate-800 mb-3">Unit Economics</h3>
        <p className="text-base text-slate-700 mb-2">Cost per analysis: <strong>$0.006</strong> • Margin: <strong>99.7%</strong></p>
        <p className="text-base text-slate-700">Path to profitability: <strong>25,000</strong> paid students</p>
      </div>
    </div>,
  ...
  return (
    <div className="min-h-screen p-5">
      {/* Main Container */}
      <div className="flex gap-5 max-w-[1400px] h-[calc(100vh-40px)] mx-auto">

        {/* Phone Mockup (Left Column) */}
        <div className="w-[420px] min-w-[380px] bg-white rounded-[20px] shadow-container flex flex-col overflow-hidden">
          {/* Phone Header */}
          <div className="bg-gradient-whatsapp text-white p-5">
            <div className="flex items-center justify-between mb-4">
              <h1 className="text-2xl font-bold">GapSense Demo</h1>
          ...
          {/* Chat Area */}
          <div className="flex-1 bg-chat-background p-4 overflow-y-auto">
          ...
          <div className="border-t border-slate-200 bg-white p-4">
            <div className="flex gap-2 mb-2">
              ...
              <button
                ...
                disabled={sending}
                className="px-4 py-2 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors text-sm font-semibold disabled:opacity-50"
              >
                📎 Upload Image
              </button>
            </div>
        ...
        <div className="flex-1 bg-white rounded-[20px] shadow-container flex flex-col overflow-hidden relative">
          {/* Slideshow Header */}
          <div className="p-5 border-b border-slate-200 flex justify-between items-center">
            <h2 className="text-xl font-semibold text-whatsapp-500">How GapSense Works</h2>
            <button
              onClick={() => setIsFullscreen(true)}
              className="w-12 h-12 rounded-full bg-slate-50 hover:bg-slate-100 text-whatsapp-500 flex items-center justify-center text-2xl transition-colors"
          ...
          >
            ...
            >
              {slides.map((slide, index) => (
                <div key={index} className="min-w-full h-full p-10 flex items-center justify-center">
                  {slide}
                </div>
              ))}
            </div>
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-white/90 hover:bg-white shadow-lg text-whatsapp-500 text-3xl flex items-center justify-center transition-all hover:scale-110"
            >
              ‹
            </button>
            <button
              onClick={() => changeSlide(1)}
              className="absolute right-4 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-white/90 hover:bg-white shadow-lg text-whatsapp-500 text-3xl flex items-center justify-center transition-all hover:scale-110"
            >
              ›
            </button>
          </div>
              ...
              {[...Array(TOTAL_SLIDES)].map((_, i) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all ${
                    i === currentSlide ? 'bg-whatsapp-500 w-8' : 'bg-slate-300 hover:bg-slate-400'
                  }`}
                />
              ))}
            </div>
